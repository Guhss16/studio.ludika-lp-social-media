...
export default function OcupandoEspaco() {
  return (
    <div className="mt-[140px] lg:mt-[120px] md:mt-[380px] text-white text-center text-xl leading-[27px] flex flex-col gap-[40px] pb-4 flex flex-col items-center lg:gap-[50px] xl:gap-[60px] sm:mt-[300px]">
