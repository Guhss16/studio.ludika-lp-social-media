...
export default function HeroSection() {
  return (
    <div className="flex flex-col items-center w-full">
      <div
        className="relative flex flex-col bg-white p-[20px] rounded-[15px] pb-[120px] xl:pb-[80px] marginPadrao
      xl:overflow-hidden
      shadow-[inset_0px_-80px_40px_-40px_rgba(254,242,0,0.3),_0px_4px_105px_0px_#E82682] xl:max-w-[95%] 2xl:max-w-[70%]"
      >
        {/*HEADER*/}
        ...
        {/*CONTEUDO */}
        <div className="flex flex-col items-center xl:items-start lg:gap-[20px] xl:px-[40px]">
          <h1 className="fonteTijolo text-4xl lg:text-6xl text-center leading-[50px] lg:leading-[70px] pb-[20px] xl:text-left xl:max-w-[70%]">
          ...
          <p className="text-center fonteNoto font-light text-[17px] lg:text-2xl lg:w-[90%] sm:text-[22px] sm:px-2 pb-[20px] xl:text-left xl:max-w-[80%] xl:text-3xl">
